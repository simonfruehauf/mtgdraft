...
function DraftRoute() {
  const { draftSettings, endDraft } = useDraft();
...
function CompleteRoute() {
  const { startDraft, endDraft } = useDraft();
  const navigate = useNavigate();
...
function AppContent() {
  const navigate = useNavigate();
  const { startDraft, endDraft, draftSettings } = useDraft();
